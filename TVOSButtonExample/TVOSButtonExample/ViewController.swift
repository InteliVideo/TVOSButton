...
class ViewController: UIViewController {
  ...
  func addSomethingToServer(_ success: @escaping () -> Void, failure: () -> Void) {
    requestSomething(success, failure: failure)
  }

  func removeSomething(_ success: @escaping () -> Void, failure: () -> Void) {
    requestSomething(success, failure: failure)
  }

  func requestSomething(_ success: @escaping () -> Void, failure: () -> Void) {
